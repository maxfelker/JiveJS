...
e.textselect(!0),!1===c.click&&c.dragging&&a.data(c.mousedown,"suppress.click",(new Date).getTime()+5),c.dragging=e.touched=!1}},hijack:function(f,c,d,g,j){if(d){var l=f.originalEvent,r=f.type,p=c.indexOf("drop")?"drag":"drop",m,q=g||0,h,n;g=!isNaN(g)?g:d.interactions.length;f.type=c;f.originalEvent=null;d.results=[];do if((h=d.interactions[q])&&!("dragend"!==c&&h.cancelled))n=e.properties(f,d,h),h.results=[],a(j||h[p]||d.droppable).each(function(g,j){n.target=j;f.isPropagationStopped=function(){return!1};
m=j?b.dispatch.call(j,f,n):null;!1===m?("drag"==p&&(h.cancelled=!0,d.propagates-=1),"drop"==c&&(h[p][g]=null)):"dropinit"==c&&h.droppable.push(e.element(m)||j);"dragstart"==c&&(h.proxy=a(e.element(m)||h.drag)[0]);h.results.push(m);delete f.result;if("dropinit"!==c)return m}),d.results[q]=e.flatten(h.results),"dropinit"==c&&(h.droppable=e.flatten(h.droppable)),"dragstart"==c&&!h.cancelled&&n.update();while(++q<g);f.type=r;f.originalEvent=l;return e.flatten(d.results)}},properties:function(a,c,d){var b=
...
c})},textselect:function(b){a(document)[b?"unbind":"bind"]("selectstart",e.dontstart).css("MozUserSelect",b?"":"none");document.unselectable=b?"off":"on"},dontstart:function(){return!1},callback:function(){}};e.callback.prototype={update:function(){d.drop&&this.available.length&&a.each(this.available,function(a){d.drop.locate(this,a)})}};var l=b.dispatch;b.dispatch=function(b){if(0<a.data(this,"suppress."+b.type)-(new Date).getTime())a.removeData(this,"suppress."+b.type);else return l.apply(this,
arguments)};var j=b.fixHooks.touchstart=b.fixHooks.touchmove=b.fixHooks.touchend=b.fixHooks.touchcancel={props:"clientX clientY pageX pageY screenX screenY".split(" "),filter:function(b,c){if(c){var d=c.touches&&c.touches[0]||c.changedTouches&&c.changedTouches[0]||null;d&&a.each(j.props,function(a,c){b[c]=d[c]})}return b}};d.draginit=d.dragstart=d.dragend=e})(jQuery);
(function(a){var b=a.event,d=b.special.drag,e=d.add,l=d.teardown;d.noBubble=!1;d.livekey="livedrag";d.add=function(j){e.apply(this,arguments);var f=a.data(this,d.datakey);!f.live&&j.selector&&(f.live=!0,b.add(this,"draginit."+d.livekey,d.delegate))};d.teardown=function(){l.apply(this,arguments);var e=a.data(this,d.datakey)||{};e.live&&(b.remove(this,"draginit."+d.livekey,d.delegate),e.live=!1)};d.delegate=function(e){var f=[],c,k=a.data(this,"events")||{};a.each(k||[],function(g,k){0===g.indexOf("drag")&&
a.each(k||[],function(k,g){if(c=a(e.target).closest(g.selector,e.currentTarget)[0])b.add(c,g.origType+"."+d.livekey,g.origHandler||g.handler,g.data),0>a.inArray(c,f)&&f.push(c)})});return!f.length?!1:a(f).bind("dragend."+d.livekey,function(){b.remove(this,"."+d.livekey)})}})(jQuery);(function(){var a=!1,b=/xyz/.test(function(){xyz})?/\b_super\b/:/.*/;this.Class=function(){};Class.create=function(d){function e(){!a&&this.initialize&&this.initialize.apply(this,arguments)}var l=this.prototype;a=!0;var j=new this;a=!1;for(var f in d)j[f]="function"==typeof d[f]&&"function"==typeof l[f]&&b.test(d[f])?function(a,b){return function(){var e=this._super;this._super=l[a];var d=b.apply(this,arguments);this._super=e;return d}}(f,d[f]):d[f];e.prototype=j;e.constructor=e;e.create=arguments.callee;
...
decimal:/^\d+\.\d{0,4}$/,price:/^\$?\s?[0-9\,]+(\.\d{0,4})?$/},init:function(){this.tabbed={};this.forms={};this.msgs={};this.msg_index=0;this.slideshows={};this.dropdowns={};this.popups={};this.popup_index=0;this.crontab={};this.crontab_index=0;this.cron(this.get_time,1E3,"jiveTime");$(document).ready(function(){$j.init_dom()})},init_dom:function(){$(document).mousemove(this.get_mouse_position);this.get_viewport_dimensions();$(window).resize(this.get_viewport_dimensions)},get_mouse_position:function(a){$j.mouse=
{x:a.pageX,y:a.pageY}},get_viewport_dimensions:function(){$j.viewport={x:$(window).width(),y:$(window).height()}},msg:function(a){this.messenger.create(a)},hello_world:function(){this.msg({type:"success",content:"<h2>Hello World!</h2><p>If you're seeing this message, it means jive is ready to use!</p>",sticky:1})},cron:function(a,b,d){d=d?d:this.crontab_index++;var e={created:new Date,stop:function(){clearTimeout(this.timer)},timer:setInterval(function(){a(e)},b)};this.crontab[d]=e},get_time:function(){var a=
new Date;$j.time={hours:a.getHours(),mins:a.getMinutes(),secs:a.getSeconds(),time_of_day:"am"};10>$j.time.mins?$j.time.mins="0"+$j.time.mins:$j.time.mins=$j.time.mins;10>$j.time.secs?$j.time.secs="0"+$j.time.secs:$j.time.secs=$j.time.secs;12<$j.time.hours&&($j.time.hours-=12,$j.time.time_of_day="pm")}};$j.init();window.$j.canopy={create:function(){$j.canopy.overlay=$('<div id="canopy-overlay"/>');$j.canopy.container=$('<div id="canopy"/>').append($('<div id="canopy-close-btn"/>').text("Close").click($j.canopy.close));$(document.body).append($j.canopy.overlay).append($j.canopy.container)},display:function(){$j.canopy.container||$j.canopy.create();$j.canopy.overlay.show();$j.canopy.container.show()},close:function(){$j.canopy.overlay.hide();$j.canopy.container.hide()}};var Messenger=Class.create({initialize:function(){var a=this;this.container=$('<div id="jive-messenger"/>');this.messages_container=$('<div id="jive-messenger-messages"/>');this.close_btn=$('<div id="jive-messenger-close" style="display:none;"/>').text("x").click(this.close);$(document).ready(function(){a.container.append(a.messages_container);a.container.append(a.close_btn);$(document.body).append(a.container)})},create:function(a){var b=this;a={id:"msg-"+$j.msg_index,type:a.type?a.type:"notify",
...
setTimeout(function(){$j.messenger.messages_container.html("")},1E3)}});$j.messenger=new Messenger;var Tabs=Class.create({initialize:function(a){var b=this;this.container_id=a.container;this.update_dom(this.container_id,a.index);this.check_hash();$j.tabbed[a.container]=this;window.onpopstate?window.onpopstate=function(){b.check_hash()}:window.onhashchange=function(){b.check_hash()}},check_hash:function(){var a=this,b=/#.+(?!\s)/g.exec(document.location);$.isArray(b)&&(tabID=b[0].replace("#",""),this.tabs.each(function(b){this.id=="tab-"+tabID&&a.show_tab(b)}))},update_dom:function(a,b){var d=this;
this.container=$("#"+a);this.tabs=this.container.find(".tab:not(#"+a+" .tabbed .tab)");this.panels=this.container.find(".panel:not(#"+a+" .tabbed .panel)");this.current_index=b?b:0;this.tabs.each(function(a){$(this).click(function(){d.current_index!=a&&d.show_tab(a)})});this.panels.hide();this.show_tab(this.current_index)},show_tab:function(a){var b=this;this.panels.hide().removeClass("current");this.tabs.removeClass("current");/^\d+$/.test(a)?this.current_index=a:this.tabs.each(function(e){this.id==
