/* jive js | minified for your health, dummy! <3 max */
...
d.textselect(!0),!1===b.click&&b.dragging&&a.data(b.mousedown,"suppress.click",(new Date).getTime()+5),b.dragging=d.touched=!1}},hijack:function(f,b,c,g,i){if(c){var k=f.originalEvent,q=f.type,n=b.indexOf("drop")?"drag":"drop",l,p=g||0,h,m,g=!isNaN(g)?g:c.interactions.length;f.type=b;f.originalEvent=null;c.results=[];do if((h=c.interactions[p])&&!("dragend"!==b&&h.cancelled))m=d.properties(f,c,h),h.results=[],a(i||h[n]||c.droppable).each(function(g,i){m.target=i;f.isPropagationStopped=function(){return!1};
l=i?e.dispatch.call(i,f,m):null;!1===l?("drag"==n&&(h.cancelled=!0,c.propagates-=1),"drop"==b&&(h[n][g]=null)):"dropinit"==b&&h.droppable.push(d.element(l)||i);"dragstart"==b&&(h.proxy=a(d.element(l)||h.drag)[0]);h.results.push(l);delete f.result;if("dropinit"!==b)return l}),c.results[p]=d.flatten(h.results),"dropinit"==b&&(h.droppable=d.flatten(h.droppable)),"dragstart"==b&&!h.cancelled&&m.update();while(++p<g);f.type=q;f.originalEvent=k;return d.flatten(c.results)}},properties:function(a,b,c){var e=
...
b})},textselect:function(c){a(document)[c?"unbind":"bind"]("selectstart",d.dontstart).css("MozUserSelect",c?"":"none");document.unselectable=c?"off":"on"},dontstart:function(){return!1},callback:function(){}};d.callback.prototype={update:function(){c.drop&&this.available.length&&a.each(this.available,function(a){c.drop.locate(this,a)})}};var k=e.dispatch;e.dispatch=function(c){if(0<a.data(this,"suppress."+c.type)-(new Date).getTime())a.removeData(this,"suppress."+c.type);else return k.apply(this,
arguments)};var i=e.fixHooks.touchstart=e.fixHooks.touchmove=e.fixHooks.touchend=e.fixHooks.touchcancel={props:"clientX clientY pageX pageY screenX screenY".split(" "),filter:function(c,b){if(b){var d=b.touches&&b.touches[0]||b.changedTouches&&b.changedTouches[0]||null;d&&a.each(i.props,function(a,b){c[b]=d[b]})}return c}};c.draginit=c.dragstart=c.dragend=d})(jQuery);
(function(a){var e=a.event,c=e.special.drag,d=c.add,k=c.teardown;c.noBubble=!1;c.livekey="livedrag";c.add=function(i){d.apply(this,arguments);var f=a.data(this,c.datakey);!f.live&&i.selector&&(f.live=!0,e.add(this,"draginit."+c.livekey,c.delegate))};c.teardown=function(){k.apply(this,arguments);var d=a.data(this,c.datakey)||{};d.live&&(e.remove(this,"draginit."+c.livekey,c.delegate),d.live=!1)};c.delegate=function(d){var f=[],b,j=a.data(this,"events")||{};a.each(j||[],function(g,j){0===g.indexOf("drag")&&
a.each(j||[],function(j,g){if(b=a(d.target).closest(g.selector,d.currentTarget)[0])e.add(b,g.origType+"."+c.livekey,g.origHandler||g.handler,g.data),0>a.inArray(b,f)&&f.push(b)})});return!f.length?!1:a(f).bind("dragend."+c.livekey,function(){e.remove(this,"."+c.livekey)})}})(jQuery);(function(){var a=!1,e=/xyz/.test(function(){xyz})?/\b_super\b/:/.*/;this.Class=function(){};Class.create=function(c){function d(){!a&&this.initialize&&this.initialize.apply(this,arguments)}var k=this.prototype;a=!0;var i=new this;a=!1;for(var f in c)i[f]="function"==typeof c[f]&&"function"==typeof k[f]&&e.test(c[f])?function(a,c){return function(){var d=this._super;this._super=k[a];var e=c.apply(this,arguments);this._super=d;return e}}(f,c[f]):c[f];d.prototype=i;d.constructor=d;d.create=arguments.callee;
...
{x:a.pageX,y:a.pageY}},get_viewport_dimensions:function(){$j.viewport={x:$(window).width(),y:$(window).height()}},msg:function(a){this.messenger.create(a)},hello_world:function(){this.msg({type:"success",content:"<h2>Hello World!</h2><p>If you're seeing this message, it means jive is ready to use!</p>",sticky:1})},cron:function(a,e,c){var c=c?c:this.crontab_index++,d={created:new Date,stop:function(){clearTimeout(this.timer)},timer:setInterval(function(){a(d)},e)};this.crontab[c]=d},get_time:function(){var a=
new Date;$j.time={hours:a.getHours(),mins:a.getMinutes(),secs:a.getSeconds(),time_of_day:"am"};10>$j.time.mins?$j.time.mins="0"+$j.time.mins:$j.time.mins=$j.time.mins;10>$j.time.secs?$j.time.secs="0"+$j.time.secs:$j.time.secs=$j.time.secs;12<$j.time.hours&&($j.time.hours-=12,$j.time.time_of_day="pm")}};$j.init();window.$j.canopy={create:function(){$j.canopy.container=$('<div id="canopy"/>').append($('<div id="canopy-close-btn"/>').text("Close").click($j.canopy.close));$j.canopy.overlay=$('<div id="canopy-overlay"/>');$(document.body).append($j.canopy.overlay).append($j.canopy.container)},display:function(){$j.canopy.container||$j.canopy.create();$j.canopy.overlay.show();$j.canopy.container.show()},close:function(){$j.canopy.overlay.hide();$j.canopy.container.hide()}};var Messenger=Class.create({initialize:function(){var a=this;this.container=$('<div id="jive-messenger"/>');this.messages_container=$('<div id="jive-messenger-messages"/>');this.close_btn=$('<div id="jive-messenger-close" style="display:none;"/>').text("x").click(this.close);$(document).ready(function(){a.container.append(a.messages_container);a.container.append(a.close_btn);$(document.body).append(a.container)})},create:function(a){var e=this,a={id:"msg-"+$j.msg_index,type:a.type?a.type:"notify",
...
clearTimeout(this.timeout);this.open&&(this.timeout=setTimeout(function(){a.open=!1;a.menu.slideUp(a.timer)},this.timer))}});$(document).ready(function(){$(".dropdown").each(function(){new Dropdown({container:this.id})})});var Popup=Class.create({initialize:function(a){var e=this,a=$.extend({container:"popup-"+$j.popup_index++,title:"",html:!1,width:$j.viewport.x/2,height:$j.viewport.y/2,top:($j.viewport.y-this.height)/2,left:($j.viewport.x-this.width)/2,offset:{top:50,left:50},confirm_close:!1,drag:!1,minimize:!1,resize_ondrag:!1},a);this.container_id=a.container;this.container=$('<div id="'+this.container_id+'" class="popup"/>').append($('<div class="popup-toolbar"/>').append($('<div class="popup-title"/>').html(a.title),
$('<div class="popup-close"/>').text("x").click(function(){e.close()})));this.content_container=$('<div id="'+this.container_id+'-contents" class="popup-contents" />');a.html&&this.set_contents(a.html);this.container.append(this.content_container);this.width=a.width;this.height=a.height;this.static_dimensions=a.width&&a.height?!0:!1;this.position={top:a.top,left:a.left,top_static:a.top?!0:!1,left_static:a.left?!0:!1};this.offset=a.offset;this.container.css({width:e.width,height:e.height,top:e.position.top,
left:e.position.left});this.confirm_close=a.confirm_close;this.drag=a.drag;this.minimize=a.minimize;this.resize_ondrag=a.resize_ondrag;$j.popups[this.container_id]=this;$(document.body).append(this.container);this.drag&&this.container.drag(function(a,d){$(this).css({top:d.offsetY,left:d.offsetX})},{handle:".popup-toolbar"});this.resize_ondrag&&(this.container.append($('<div class="popup-resize"/>')),this.container.drag("start",function(a,d){d.width=$(this).width();d.height=$(this).height()}).drag(function(a,
d){$(this).css({width:Math.max(20,d.width+d.deltaX),height:Math.max(20,d.height+d.deltaY)})},{handle:".popup-resize"}));$(window).resize(function(){e.update()});this.update()},update:function(){this.static_dimensions||this.resize();this.reposition();this.container.css({width:this.width,height:this.height,top:this.position.top,left:this.position.left})},reposition:function(){this.position.top_static||(this.position.top=($j.viewport.y-this.height)/2,this.position.top<this.offset.top&&(this.position.top=
this.offset.top));this.position.left_static||(this.position.left=($j.viewport.x-this.width)/2,this.position.left<this.offset.left&&(this.position.left=this.offset.left))},resize:function(){this.width=$j.viewport.x/2;this.height=$j.viewport.y/2},close:function(a){this.confirm_close?confirm("Are you sure you would like to close this window?")&&(a?(this.container.remove(),delete $j.popups[this.container_id]):this.container.hide()):a?(this.container.remove(),delete $j.popups[this.container_id]):this.container.hide()},
set_title:function(a){this.container.find(".popup-title").html(a)},set_contents:function(a){this.content_container.html(a)}});$j.modal={display:function(a){a=$.extend({container:"modal"},a);new Popup(a);this.popup=$j.popups.modal;$j.canopy.display();$("#canopy-close-btn").hide();$("#modal").find(".popup-close").addClass("btn btn-large");$("#modal").find(".popup-close").click(function(){$j.canopy.close()})},close:function(){$j.canopy.close();this.popup.close()},resize:function(a){this.popup.width=a.width;this.popup.height=a.height;this.popup.update()}};var Slideshow=Class.create({initialize:function(a){$j.slideshows[a.container]=this;this.container=$("#"+a.container);this.slides=this.container.find(".slide");this.slide_duration=a.duration?a.duration:5E3;this.autostart=a.autostart?a.autostart:!1;this.loop=a.loop?a.loop:!0;this.current_index=(this.reverse=a.reverse?a.reverse:!1)?this.slides.length-1:0;this.completed=this.playing=!1;this.slides.hide();this.show_slide();this.container.hasClass("autostart")&&this.start()},show_slide:function(){if(!this.loop&&
this.current_index>=this.slides.length)return this.current_index=this.slides.length-1,this.stop(),!1;this.current_index>=this.slides.length&&(this.current_index=0);if(!this.loop&&0>this.current_index)return this.current_index=0,this.stop(),!1;0>this.current_index&&(this.current_index=this.slides.length-1);this.current_slide=$(this.slides[this.current_index]);this.slides.each(function(){$(this).hasClass("slide-current")||$(this).hide()});this.current_slide.show()},start:function(){var a=this,e=$(this.container).attr("id");
if(this.playing)return!1;this.reverse?(this.playing=!0,$j.cron(function(){a.previous_slide()},this.slide_duration,e)):(this.playing=!0,$j.cron(function(){a.next_slide()},this.slide_duration,e));this.completed=!1},stop:function(){var a=$(this.container).attr("id");$j.crontab[a].stop();this.completed=!0;this.playing=!1},restart:function(){if(this.playing)return!1;this.reset();this.start()},reset:function(){this.stop();this.current_index=this.reverse?this.slides.length-1:0;this.show_slide()},next_slide:function(){this.current_index++;
this.show_slide()},previous_slide:function(){this.current_index--;this.show_slide()}});$(document).ready(function(){$(".jive-slideshow").each(function(){new Slideshow({container:this.id})})});