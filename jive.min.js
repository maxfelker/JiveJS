...
{x:$(window).width(),y:$(window).height()}},msg:function(a){this.messenger.create(a)},hello_world:function(){this.msg({type:"success",content:"<h2>Hello World!</h2><p>If you're seeing this message, it means jive is ready to use!</p>",sticky:1})},cron:function(a,e,c){var c=c?c:this.crontab_index++,d={created:new Date,stop:function(){clearTimeout(this.timer)},timer:setInterval(function(){a(d)},e)};this.crontab[c]=d}};$j.init();window.$j.canopy={create:function(){$j.canopy.container=$('<div id="canopy"/>').append($('<div id="canopy-close-btn"/>').text("Close").click($j.canopy.close));$j.canopy.overlay=$('<div id="canopy-overlay"/>');$(document.body).append($j.canopy.overlay).append($j.canopy.container)},display:function(){$j.canopy.container||$j.canopy.create();$j.canopy.overlay.show();$j.canopy.container.show()},close:function(){$j.canopy.overlay.hide();$j.canopy.container.hide()}};var Messenger=Class.create({initialize:function(){var a=this;this.container=$('<div id="jive-messenger"/>');this.messages_container=$('<div id="jive-messenger-messages"/>');this.close_btn=$('<div id="jive-messenger-close" style="display:none;"/>').text("x").click(this.close);$(document).ready(function(){a.container.append(a.messages_container);a.container.append(a.close_btn);$(document.body).append(a.container)})},create:function(a){var e=this,a={id:"msg-"+$j.msg_index,type:a.type?a.type:"notify",
